...
recommendedPlaces.forEach((place, idx) => {
    ...
    btn.innerText = place;
    btn.className = "border-1 broder-gray-300 hover:bg-blue-900 hover:text-white transition duration-500 text-blue-800 text-sm px-4 py-1 rounded-full transition cursor-pointer mb-3";
